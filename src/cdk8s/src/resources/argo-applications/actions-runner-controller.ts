        ...
        source: {
          ...
          helm: {
            valuesObject: {
              ...
              // Dagger spans are generated by the *client* (the runner/job that invokes `dagger`),
              // not just the in-cluster engine. Without these env vars, Tempo will only show
              // a tiny subset (e.g. engine readiness probe traces) and miss CI pipeline traces.
              template: {
                spec: {
                  containers: [
                    {

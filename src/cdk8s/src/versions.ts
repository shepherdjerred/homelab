const versions = {
  ...
  // renovate: datasource=docker registryUrl=https://ghcr.io versioning=docker
  "home-assistant/home-assistant": "2025.12.4@sha256:75ef6851d2e48d366764cdb6b569b7ad8be77dcc8e0d1b9aa508ac90e42d4c58",
  ...
  // not managed by renovate
  "shepherdjerred/sjer.red": "1.0.91",
  ...
  // not managed by renovate
  "shepherdjerred/webring-docs": "377b42bbe8e44586cd8a806d4334af85638e79d3",
  ...
  // not managed by renovate
  "shepherdjerred/better-skill-capped": "1.0.91",
  // Custom better-skill-capped-fetcher image - updated by CI pipeline
  // not managed by renovate
  "shepherdjerred/better-skill-capped-fetcher": "1.0.91",
  // renovate: datasource=docker registryUrl=https://ghcr.io versioning=semver
  ...
  openebs: "4.4.0",
  // not managed by renovate
  "shepherdjerred/scout-for-lol/beta": "1.0.113",
  // not managed by renovate
  "shepherdjerred/scout-for-lol/prod": "1.0.108",
  // not managed by renovate
  "shepherdjerred/starlight-karma-bot/beta": "1.0.14",
  // not managed by renovate
  "shepherdjerred/starlight-karma-bot/prod": "1.0.13",
  // not managed by renovate
  "shepherdjerred/birmel": "1.0.533",
  // not managed by renovate

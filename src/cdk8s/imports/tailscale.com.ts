...
export function toJson_RecorderSpecStatefulSetPodContainer(
  ...
  const result = {
    "env": obj.env?.map((y) =>
      toJson_RecorderSpecStatefulSetPodContainerEnv(y)
    ),
    "image": obj.image,
    "imagePullPolicy": obj.imagePullPolicy,
    ...
    "securityContext":
      toJson_RecorderSpecStatefulSetPodContainerSecurityContext(
        obj.securityContext,
      ),
  };
  // filter undefined values
...
export interface RecorderSpecStatefulSetPodSecurityContext {
   ...
   */
  readonly appArmorProfile?:
    RecorderSpecStatefulSetPodSecurityContextAppArmorProfile;
   ...
   */
  readonly seLinuxOptions?:
    RecorderSpecStatefulSetPodSecurityContextSeLinuxOptions;
   ...
   */
  readonly windowsOptions?:
    RecorderSpecStatefulSetPodSecurityContextWindowsOptions;
}

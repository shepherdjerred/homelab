...
export function toJson_NodeFeatureSpecFeatures(
  ...
  const result = {
    ...
    "flags": ((obj.flags) === undefined)
      ? undefined
      : (Object.entries(obj.flags).reduce((r, i) =>
        (i[1] === undefined)
          ? r
          : ({ ...r, [i[0]]: toJson_NodeFeatureSpecFeaturesFlags(i[1]) }), {})),
    "instances": ((obj.instances) === undefined)
      ? undefined
      : (Object.entries(obj.instances).reduce(
        (r, i) =>
          (i[1] === undefined)
            ? r
            : ({ ...r, [i[0]]: toJson_NodeFeatureSpecFeaturesInstances(i[1]) }),
        {},
      )),
  };
  // filter undefined values
...
export function toJson_NodeFeatureSpecFeaturesAttributes(
  ...
  if (obj === undefined) return undefined;
  const result = {
    "elements": ((obj.elements) === undefined)
      ? undefined
...
export function toJson_NodeFeatureRuleSpecRules(
  ...
  const result = {
    ...
    "extendedResources": ((obj.extendedResources) === undefined)
      ? undefined
  ...
  const result = {
    ...
    "matchExpressions": ((obj.matchExpressions) === undefined)
      ...
      : (Object.entries(obj.matchExpressions).reduce((r, i) =>
        (i[1] === undefined) ? r : ({
          ...r,
          [i[0]]: toJson_NodeFeatureRuleSpecRulesMatchFeaturesMatchExpressions(
            i[1],
          ),
        }), {})),

const versions = {
  ...
  // renovate: datasource=docker registryUrl=ghcr.io versioning=semver
  ...
  // renovate: datasource=docker registryUrl=quay.io versioning=docker
  "invidious/invidious":
  ...
  // renovate: datasource=docker registryUrl=ghcr.io versioning=docker
  ...
  // renovate: datasource=docker registryUrl=ghcr.io versioning=semver-coerced
  "qdm12/gluetun":
